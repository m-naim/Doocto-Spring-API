...
public class SecurityConfig extends WebSecurityConfigurerAdapter  {
      ...
      http
              ...
              .authorizeRequests()
                  ...
                  .antMatchers("/auth/**", "/oauth2/**")
                      .permitAll()
                  .antMatchers(HttpMethod.GET,"/allProffesions/**","/locationss/**","/confirm-account**","/sendemail/**","/doctors/**","/professions/**","/location/**","/doc/**", "/booked","/communes/**","/wilayas/**","/doctorss/**","/doctorsInscriptionManager/**")
                  	  .permitAll()
                  .antMatchers("/doc/**")
              	  .hasRole("USER")
                  .antMatchers("/doctors/**","/professions/**","/users/**","/location/**")
                	  .hasRole("ADMIN")
                  .anyRequest()
                      .authenticated()
                  .and()
  ...
  public CorsConfigurationSource corsConfigurationSource() {
      ...
      configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200","https://www.tabibrdv.com/"));
