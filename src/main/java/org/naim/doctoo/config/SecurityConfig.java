      ...
      http
              ...
              .authorizeRequests()
                  ...
                  .antMatchers("/auth/**", "/oauth2/**")
                      .permitAll()
                  .antMatchers(HttpMethod.GET,"/up","/allProffesions/**","/locationss/**","/confirm-account**","/sendemail/**","/doctors/**","/professions/**","/location/**","/doc/**", "/booked","/communes/**","/wilayas/**","/doctorss/**","/doctorsInscriptionManager/**")
                  	  .permitAll()
                  .antMatchers("/doc/**")
              	  .hasRole("USER")
